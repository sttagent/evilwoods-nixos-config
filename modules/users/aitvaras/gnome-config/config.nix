...
in
{
  den.aspects.aitvaras.gnome.homeManager =
    { host, user, ... }:
    {
      home = {
        file = {
      ...
      dconf.settings = {
        ...
        "org/gnome/desktop/background" = {
          picture-uri = "file:///home/${user.name}/.config/background";
          picture-uri-dark = "file:///home/${user.name}/.config/background";
  ...
  den.aspects.aitvaras = {
    includes = [
      (den.lib.policy.when (
        { host, ... }: host.hasAspect den.aspects.desktop-environment.gnome
